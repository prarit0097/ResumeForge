...
def extract_and_enhance_messages(raw: str, jd: str | None = None) -> list[dict]:
    ...
    return [
        {"role": "system", "content": (
            ...
            "'skills' section with 8-12 relevant skill keywords drawn from the "
            "candidate's titles, summary and experience (tools, methodologies, "
            "domains, competencies they clearly demonstrate — e.g. for a sales "
            "leader: Sales Strategy, Revenue Growth, Team Leadership, P&L Management, "
            "Business Development, CRM, Operations). Keep all companies, titles, "
...
def enhance_messages(data: dict, jd: str | None = None) -> list[dict]:
    ...
    return [
        {"role": "system", "content": (
            ...
            "never fabricate). Output CLEAN resume text only — NO quotation marks "
